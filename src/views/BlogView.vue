...
<template>
  <div class="min-h-screen">
    <!-- ヘッダー -->
    <div class="bg-gradient-to-r from-primary-50 to-primary-100 py-12 mb-8 -mx-4 sm:-mx-6 lg:-mx-8 -mt-8">
      ...
      <div class="flex gap-2">
        <div class="flex-1 relative">
          <input
            ...
            type="text"
            placeholder="記事を検索..."
            class="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
          >
    ...
    <!-- ブログカードグリッド -->
    <div v-if="blogStore.paginatedPosts.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      <BlogCard 
